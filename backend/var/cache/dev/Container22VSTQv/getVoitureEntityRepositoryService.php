...
// Returns the private 'App\Repository\VoitureEntityRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/VoitureEntityRepository.php';

return $this->privates['App\\Repository\\VoitureEntityRepository'] = new \App\Repository\VoitureEntityRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
